  ...
  return (
    <section id="preco" className="max-w-7xl mx-auto px-8 py-32">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[3rem] p-12 text-white shadow-2xl shadow-amber-500/10 transform hover:scale-[1.02] transition-transform relative overflow-hidden group">
          ...
          <Link
            href="/registro"
            className="block w-full bg-amber-600 text-white py-6 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-amber-500 transition-all shadow-xl text-center relative z-10"
          >
