  ...
  return (
    <section id="seguranca" className="relative max-w-7xl mx-auto px-8 py-24 border-t border-white/5 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] bg-green-500/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/3 w-[400px] h-[400px] bg-blue-500/5 rounded-full blur-3xl"></div>
      </div>

      <div className="relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight leading-tight">
            Segurança que você <span className="text-green-500">confia</span>
          </h2>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Seus dados protegidos com criptografia de ponta a ponta e infraestrutura segura.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl hover:border-green-500/30 transition-colors group">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl hover:border-green-500/30 transition-colors group">
            <div className="w-12 h-12 rounded-xl bg-green-500/10 flex items-center justify-center mb-4 group-hover:bg-green-500/20 transition-colors">
              <Lock className="w-6 h-6 text-green-500" strokeWidth={2} />
            </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl hover:border-green-500/30 transition-colors group">
            <div className="w-12 h-12 rounded-xl bg-green-500/10 flex items-center justify-center mb-4 group-hover:bg-green-500/20 transition-colors">
              <Eye className="w-6 h-6 text-green-500" strokeWidth={2} />
            </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl hover:border-green-500/30 transition-colors group">
            <div className="w-12 h-12 rounded-xl bg-green-500/10 flex items-center justify-center mb-4 group-hover:bg-green-500/20 transition-colors">
              <FileCheck className="w-6 h-6 text-green-500" strokeWidth={2} />
            </div>
