...
export default function CargosUsuariosPage() {
  ...
  return (
    <div className="flex flex-col gap-4 bg-muted/60 p-4 md:p-6">
      <h1 className="text-2xl font-bold text-foreground">Cargos e usuários</h1>
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-52 rounded-lg border border-border bg-background py-2 pl-8 pr-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500/20"
                    />
                  </div>
                  <button
                    type="button"
              ...
              <div className="max-h-[60vh] overflow-auto">
                <table className="w-full min-w-[400px]">
                  <thead>
                    <tr className="sticky top-0 z-10 border-b border-border bg-muted/40">
                      ...
                      <th className="px-4 py-3 text-left text-xs font-semibold uppercase text-muted-foreground">Permissões</th>
              ...
              <div className="flex items-center justify-between gap-2 border-t border-border bg-muted/40 px-4 py-2">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="rounded p-2 text-muted-foreground hover:bg-card hover:text-foreground disabled:pointer-events-none disabled:opacity-40"
                ...
                <div className="flex items-center gap-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-56 rounded-lg border border-border bg-card py-2 pl-8 pr-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500/20"
                    />
                  </div>
                  <button
                    type="button"
                    onClick={openUserManagement}
                    className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-card px-3 py-2 text-sm font-medium text-foreground hover:bg-muted/40"
                  >
                ...
                <table className="w-full min-w-[520px]">
                  <thead>
                    <tr className="sticky top-0 z-10 border-b border-border bg-muted/40">
                      ...
                      <th className="px-3 py-2.5 text-left text-xs font-semibold uppercase text-muted-foreground">Nome / E-mail</th>
                      <th className="px-3 py-2.5 text-left text-xs font-semibold uppercase text-muted-foreground">WhatsApp</th>
                      <th className="px-3 py-2.5 text-left text-xs font-semibold uppercase text-muted-foreground">Cargo</th>
                      <th className="px-3 py-2.5 text-left text-xs font-semibold uppercase text-muted-foreground">Ativo</th>
                      <th className="px-3 py-2.5 text-right text-xs font-semibold uppercase text-muted-foreground">Ações</th>
                    </tr>
                  </thead>
                  <tbody>
                    {pagedUsers.map((u) => (
                      <tr key={u.id} className="border-b border-border last:border-0 hover:bg-muted/40">
                        ...
                        <td className="px-3 py-2.5 text-sm text-muted-foreground">{u.phone ? `+55 ${u.phone}` : "—"}</td>
                        <td className="px-3 py-2.5 text-sm text-muted-foreground">{u.role_name ?? "—"}</td>
                        <td className="px-3 py-2.5">
                          {u.is_owner ? (
                            ...
                            <button
                              ...
                              className={`relative inline-flex h-6 w-10 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:ring-offset-1 disabled:opacity-50 ${
                                u.is_active !== false ? "bg-clicvend-orange" : "bg-muted"
                              }`}
                              role="switch"
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-1 overflow-x-auto pb-2 -mx-1">
            <button
              ...
              className={`flex items-center gap-1.5 shrink-0 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
                roleSideOverTab === "cargo" ? "bg-clicvend-orange/10 text-amber-600 dark:text-amber-400" : "text-muted-foreground hover:bg-muted/60"
              }`}
            >
              <Briefcase className="h-4 w-4" />
              Cargo
            ...
            <button
              ...
              className={`flex items-center gap-1.5 shrink-0 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
                roleSideOverTab === "usuarios" ? "bg-clicvend-orange/10 text-amber-600 dark:text-amber-400" : "text-muted-foreground hover:bg-muted/60"
              }`}
            >
          ...
          {roleSideOverTab === "cargo" && (
            <div className="space-y-4">
              <div>
                <label className="mb-1 block text-sm font-medium text-foreground">Nome do cargo</label>
                <input
                  type="text"
                  value={roleName}
              ...
              <div>
                <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <button
                      ...
                      className="rounded-lg border border-border px-3 py-1.5 text-xs font-medium text-muted-foreground transition-colors hover:border-clicvend-orange hover:text-amber-600 dark:hover:text-amber-400"
                    >
                      Marcar todas
                    </button>
                    <button
                ...
                <p className="mb-2 text-xs text-muted-foreground">Marque os acessos e ações que este cargo terá em cada módulo.</p>
                <div className="space-y-4 max-h-[420px] overflow-auto rounded-lg border border-border bg-muted/40 p-3">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-1 overflow-x-auto pb-2 -mx-1">
            <button
              ...
              className={`flex items-center gap-1.5 shrink-0 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
                userSideOverTab === "lista" ? "bg-clicvend-orange/10 text-amber-600 dark:text-amber-400" : "text-muted-foreground hover:bg-muted/60"
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 shrink-0 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
                userSideOverTab === "form" ? "bg-clicvend-orange/10 text-amber-600 dark:text-amber-400" : "text-muted-foreground hover:bg-muted/60"
              }`}
            >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-lg bg-clicvend-orange/10 px-3 py-2 text-sm font-medium text-amber-600 dark:text-amber-400 hover:bg-clicvend-orange/20 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-border px-3 py-2 text-foreground focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500/20 disabled:bg-muted/60 disabled:text-muted-foreground"
                />
              </div>
              <div>
              ...
              {!editingUser ? (
                <>
                  <div>
                    <label className="mb-1 block text-sm font-medium text-foreground">Senha inicial</label>
                    <p className="mb-1.5 text-xs text-muted-foreground">Pode colar a senha para compartilhar com o usuário. Use &quot;Mostrar senha&quot; para copiar.</p>
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 rounded-lg border border-border px-3 py-2 text-foreground focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500/20"
                      />
                      <button
                        type="button"
                        onClick={() => setUserShowPassword((p) => !p)}
                        className="rounded-lg border border-border px-3 py-2 text-muted-foreground hover:bg-muted/40"
                ...
                <p className="text-xs text-muted-foreground">Deixe a senha em branco para não alterar. Para redefinir, use a opção de recuperação ou altere em edição (futuro).</p>
              )}
              <div>
              ...
              <div>
                <label className="mb-1 block text-sm font-medium text-foreground">Caixas de atendimento</label>
                <p className="mb-2 text-xs text-muted-foreground">Usuário poderá ver e atender conversas destas caixas (atendimentos normais da fila).</p>
                <div className="max-h-40 overflow-auto rounded-lg border border-border bg-muted/40 p-2 space-y-1">
                  {queues.map((q) => (
                ...
                {queues.length === 0 && <p className="text-xs text-muted-foreground">Nenhuma caixa cadastrada. Crie em Filas.</p>}
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-foreground">Responsabilidades em grupos</label>
                ...
                <div className="max-h-48 overflow-auto rounded-lg border border-border bg-muted/40 p-2 space-y-3">
                  {channels.length === 0 && (
                    <p className="text-xs text-muted-foreground">Nenhum canal. Conecte um canal em Conexões para sincronizar grupos.</p>
                  )}
                  {channels.map((ch) => {
                    ...
                    return (
                      <div key={ch.id}>
                        <div className="text-xs font-medium text-muted-foreground mb-1">{ch.name}</div>
                  ...
                  {channels.length > 0 && channelGroups.filter((g) => !g.left_at).length === 0 && (
                    <p className="text-xs text-muted-foreground">Nenhum grupo sincronizado. Sincronize contatos nos canais para listar grupos.</p>
                  )}
                </div>
              </div>
              {error && <p className="text-sm text-red-600">{error}</p>}
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <div className="inline-flex w-fit overflow-hidden rounded-lg border border-border bg-card">
            <button
              type="button"
              onClick={() => setBulkQueueMode("add")}
              className={`px-3 py-2 text-sm font-medium ${bulkQueueMode === "add" ? "bg-clicvend-orange/10 text-amber-600 dark:text-amber-400" : "text-muted-foreground hover:bg-muted/40"}`}
            >
              Adicionar filas
            </button>
            <button
              ...
              className={`border-l border-border px-3 py-2 text-sm font-medium ${bulkQueueMode === "replace" ? "bg-clicvend-orange/10 text-amber-600 dark:text-amber-400" : "text-muted-foreground hover:bg-muted/40"}`}
            >
              Substituir filas
            </button>
          </div>
          ...
          <div>
            <label className="mb-2 block text-sm font-medium text-foreground">Filas</label>
            <div className="max-h-64 overflow-auto rounded-lg border border-border bg-muted/40 p-2">
              {queues.length === 0 ? (
                <p className="text-xs text-muted-foreground">Nenhuma fila cadastrada.</p>
              ) : (
                <div className="space-y-1">
                  {queues.map((q) => (
                    <label key={q.id} className="flex items-center gap-2 rounded px-1 py-1.5 text-sm text-foreground hover:bg-card">
                      <input
                        type="checkbox"
