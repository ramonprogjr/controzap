...
export function getPublicSupabaseUrl(): string {
  return pickEnvOrDefault(process.env.NEXT_PUBLIC_SUPABASE_URL, SUPABASE_URL);
}

export function getPublicSupabaseAnonKey(): string {
  return pickEnvOrDefault(process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY, SUPABASE_ANON_KEY);
}
